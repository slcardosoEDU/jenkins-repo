...
namespace Pi.Math
{
    public class HighPrecision
    {
        ...
        public HighPrecision(BigInteger numerator, BigInteger denomiator)
        {
            // public constructor rescales numerator as needed
            num = (HighPrecision.denom * numerator) / denomiator;
        }

        private HighPrecision(BigInteger numerator) 
        {
            // private constructor for when we already now the scaling
            num = numerator;
        }
        ...
        {
            // no need to rescale when multiplying by an int
        ...
        {
            // no need to resacale when dividing by an int
        ...
        public override string ToString()
        {
            ...
            // pull out the 0s after the decimal point
